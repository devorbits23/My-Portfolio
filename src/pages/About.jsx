...
const About = () => {
  return (
    <section
      id="about"
      className="about text-white px-8 py-28 bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a]"
    >
      {/* Hero Banner */}
      <div className="text-center mb-16">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-wide mb-4 text-indigo-400">
          About Me
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
        {/* My Journey */}
        <div className="border border-gray-700 rounded-xl p-6 shadow-md 
                        bg-gradient-to-br from-[#0f172a]/80 via-[#1e293b]/70 to-[#0f172a]/80 
                        backdrop-blur-md hover:shadow-[0_0_25px_rgba(99,102,241,0.6)] transition-all duration-500">
          <h2 className="text-xl sm:text-2xl font-bold mb-4">👨‍💻 My Journey</h2>
          <p className="text-gray-300 mb-4">
            I began my coding journey with a fascination for interactive, cinematic websites. Over time,
            I mastered React, Node.js, MongoDB, and Tailwind CSS, while exploring advanced animation
            frameworks. My focus has always been blending reliability with creativity.
          </p>
          <p className="text-gray-300">
            Currently, I’m expanding the <span className="text-blue-400">Orbit Suite</span> — apps like
            ShopOrbit, SongOrbit, TasteOrbit, and WorkOrbit — each showcasing my full‑stack skills and
        ...
        <div className="border border-gray-700 rounded-xl p-6 shadow-md 
                        bg-gradient-to-br from-[#0f172a]/80 via-[#1e293b]/70 to-[#0f172a]/80 
                        backdrop-blur-md hover:shadow-[0_0_25px_rgba(99,102,241,0.6)] transition-all duration-500 md:col-span-2">
        ...
        <div className="border border-gray-700 rounded-xl p-6 shadow-md 
          ...
          <p className="text-gray-300">
            ...
            My workflow combines prototyping, accessibility checks, and performance tuning. I value
            collaboration and feedback, ensuring every project aligns with both technical standards and
            creative vision.
          </p>
        </div>
      </div>
